...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_MarcelManjares')
	 Begin 
	  Alter Database [Assignment07DB_MarcelManjares] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_MarcelManjares;
	 End
	Create Database Assignment07DB_MarcelManjares;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_MarcelManjares;
